...
extern double  massbal_getStepFlowError(void);
...
extern void subcatch_setParams(int i, double x[]);
...
extern void link_setParams(int j, int type, int n1, int n2, int k, double x[]);
// extern void    link_setLossParams(int j, int type, int k, double x);
