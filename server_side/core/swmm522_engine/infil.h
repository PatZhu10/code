...
int     grnampt_setParams(TGrnAmpt *infilParams, double p[]);
void    grnampt_initState(TGrnAmpt *infilParams);
double  grnampt_getInfil(TGrnAmpt *infilParams, double tstep, double irate,
