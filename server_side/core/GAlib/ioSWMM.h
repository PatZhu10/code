...
extern std::vector <I_Storage> I_storageData;
...
extern std::vector <double> AllSimNodeHead;
...
extern void outputNodeHeadToFile(const std::string &outputNodeHeadFile, const std::vector<double> &WLS_AllSimNodeHead);
