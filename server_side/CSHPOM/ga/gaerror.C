...
static const char* __gaErrStr[] = {
  ...
  "number of individuals for replacement must be less than pop size",
  ...
  "children must have the same resize behavior for any given dimension",
  ...
  "length of binary string exceeds the maximum for this computer/OS type.",
