...
typedef enum {
    ...
    swmm_SUBCATCH_FRACIMPERV  = 209,
    swmm_SUBCATCH_IMPERV01_N  = 210,
    swmm_SUBCATCH_PERV_N    = 211,
    swmm_SUBCATCH_IMPERV0_DSTORE  = 212,
    swmm_SUBCATCH_IMPERV1_DSTORE  = 213,
    swmm_SUBCATCH_PERV_DSTORE     = 214,
    swmm_SUBCATCH_IMPERV0_FAREA   = 215,
    // swmm_INFILTRATION_F0        = 216,
...
typedef enum {
    ...
    swmm_LINK_ROUGHNESS  = 415,
    swmm_LINK_OFFSET1    = 416,
    swmm_LINK_OFFSET2    = 417,
    swmm_LINK_Q0         = 418,
    swmm_LINK_QLIMIT     = 419,
    swmm_LINK_CLOSSINLET = 420,
    swmm_LINK_CLOSSOUTLET = 421,
    swmm_LINK_CLOSSAVG   = 422,
    swmm_LINK_SEEPLOSSRATE = 423,
    swmm_LINK_YWMAX      = 424,
    swmm_PUMP_CURVE      = 425,
    swmm_PUMP_INITIALSETTING  = 426,
    swmm_PUMP_YON        = 427,
    swmm_PUMP_YOFF       = 428
} swmm_LinkProperty;

typedef enum {
    swmm_INFILTRATION_F0        = 501,
    swmm_INFILTRATION_FMIN      = 502,
    swmm_INFILTRATION_DECAY     = 503,
    swmm_INFILTRATION_REGEN     = 504,
    swmm_INFILTRATION_FMAX      = 505
} swmm_InfiltrationProperty;
