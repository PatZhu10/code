...
router.post('/', (req, res) => {
    const build = 'cd CSHPOM/ga;make;cd ..;cd ./swmm522_engine/build;cmake ..;cmake --build .;cd ../../;g++ -I. cshpom.cpp -o cshpom -L./ga -L./swmm522_engine/build -lga -lswmm5 -lrt;cd ..;export LD_LIBRARY_PATH=CSHPOM/ga:CSHPOM/swmm522_engine/build;';
